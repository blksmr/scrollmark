  ...
  return (
    <div className="relative">
      ...
      <a
        ...
        className="absolute bottom-2 right-2 p-1 bg-fd-background/80 backdrop-blur-sm border border-border rounded-lg text-fd-muted-foreground hover:text-fd-foreground hover:bg-fd-background transition-colors"
